...
function Header() {
	...
	return (
		<nav className="relative flex flex-row justify-between items-center w-full py-6 px-4 lg:px-[4.5rem] max-w-screen-xl mx-auto">
			<Link href="/">
					...
					>
						<g clipPath="url(#clip0_828_102)">
							<path
								...
								stroke="url(#paint0_linear_828_102)"
								strokeWidth="3"
							/>
							<path
								fillRule="evenodd"
						...
						<defs>
							...
							>
								<stop stopColor="#B1812E" />
								<stop offset="1" stopColor="#E7DE9C" />
							</linearGradient>
							<linearGradient
								id="paint1_linear_828_102"
								x1="0.470703"
								y1="14.1564"
								x2="55.8211"
								y2="14.1564"
							...
							>
								<stop stopColor="#B1812E" />
								<stop offset="1" stopColor="#49654E" />
							</linearGradient>
