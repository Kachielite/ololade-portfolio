...
function Home() {
	...
	const design_process = [
		{
			...
			details:
				"Before jumping into designs, I identify the product's objectives and audience. This includes conducting user research, competitive analysis, market analysis and exploring the solutions that already exist.",
		},
		{
			id: 1,
			show: false,
		...
		},
		{
			...
			details:
				'I would work with your developers to make sure that the design gets implemented the way we envisioned it to work, and provides the experience we want.',
		},
		{
			id: 3,
			show: false,
			...
			subtitle: 'Iteration:',
			details:
				'No design is perfect because design is an iterative process, and for that, we always have to keep going back to the user to learn and iterate. An ideal design process never ends, keeps on learning and keeps on improving over time.',
		},
	];
	...
	const designProcessCardHandler = (id) => {
		const newProcessList = [...selectedProcess];
		newProcessList
		...
		<Layout>
			...
			>
						...
						<div className="flex flex-col md:flex-row justify-center items-center space-x-6">
							...
							>
								...
								<span className="ml-2.5">
									...
									>
										<path
											d="M7 13.125L12 18.125L17 13.125"
											stroke="#8BA889"
											strokeWidth="2"
											strokeLinecap="round"
				...
				<section className="w-full bg-[#253528]" id="about">
					<div className="w-full flex flex-col lg:flex-row justify-between items-start px-4 lg:px-[6.7rem] py-24 max-w-screen-xl mx-auto">
						<div className="flex flex-col justify-start items-start lg:w-[45.8rem]">
							...
							<h2 className="font-bold text-white text-[2.5rem] mb-6">
								About Me
							</h2>
							<div className="flex flex-col justify-start items-start space-y-6 mb-6">
								<p className="font-light text-2xl text-white leading-[2.5rem]">
									...
									. This is why I’m constantly exploring new ways products can
								...
								<p className="font-light text-2xl text-white leading-[2.5rem]">
									...
									&{' '}
									<a
										href="https://genleaders.org/about-us"
										className="underline underline-offset-4"
									>
										GenLeaders
									</a>
									. If you can't find me at any of these places, I'm either
									playing music, bingeing Netflix, or obsessing over anything
									design.
								</p>
							</div>
							<a
						...
						<div className="w-full lg:w-[28.8rem] h-[41.1rem] mt-10 lg:mt-0">
							<Image
								src={Ololade}
								alt="Ololade's pic"
								className="w-full lg:w-[28.8rem] h-[41.1rem] object-contain"
							/>
						</div>
					</div>
				</section>
				<section id="process" className="w-full max-w-screen-xl mx-auto">
					<div className="w-full flex flex-col justify-start items-start px-4 lg:px-[7.5rem] py-12">
						<p className="font-normal text-[#253528] text-base  mb-2">
							Here's my deal
						</p>
						<h2 className="font-bold text-[#253528] text-[2.5rem] mb-6">
							Design Process
						</h2>
						<p className="font-normal text-[#253528]  text-base  mb-2 max-w-[40rem]">
							How I make your business reach your goals by aligning them to
							"real" user needs.
						</p>
							...
							{selectedProcess.map((item) => (
								...
								>
									<div className="w-full flex flex-row justify-between items-center">
										<h3 className="text-[#253528] font-bold text-xl">
											{item.title}
										</h3>
										{!item.show ? (
											<svg
									...
									{item.show && (
										<p className="text-xl font-normal text-[#253528]">
				...
				<section id="work" className="w-full bg-[#253528]">
					<div className="w-full flex flex-col justify-between items-start px-4 lg:px-[7.5rem] py-12 max-w-screen-xl mx-auto">
							...
							{works.map((item) => (
								...
								>
									...
									<div className="w-full flex flex-row justify-between items-center mt-8">
										<h3 className="font-bold text-white text-base md:text-[2rem]">
											{item.title}
										</h3>
										<Link href="/">
									...
									<div className="w-full h-[10rem] md:h-[16.5rem] absolute bottom-0 left-0 z-20 bg-gradient-to-t from-[#1B261D] to-[#1B261D]/[.35] overflow-y-hidden " />
								</Link>
							))}
						</div>
					</div>
